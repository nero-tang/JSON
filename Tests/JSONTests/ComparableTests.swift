...
class ComparableTests: TestCase {
  ...
  func testNumberEqual() {
    ...
    let jsonR1 = JSON(1234567890.876623)
    XCTAssertEqual(jsonL1, jsonR1)
    XCTAssertTrue(jsonL1 == 1234567890.876623)

    let jsonL2: JSON = 987654321
    let jsonR2 = JSON(987654321)
    XCTAssertEqual(jsonL2, jsonR2)
    XCTAssertTrue(jsonR2 == 987654321)

    let jsonL3 = JSON(NSNumber(value: 87654321.12345678))
    let jsonR3 = JSON(NSNumber(value: 87654321.12345678))
  ...
  func testNumberNotEqual() {
    ...
    let jsonL3 = JSON(NSNumber(value: 87621.12345678))
    let jsonR3 = JSON(NSNumber(value: 87654321.45678))
  ...
  func testNumberGreaterThanOrEqual() {
    ...
    let jsonL3 = JSON(NSNumber(value: 87621.12345678))
    let jsonR3 = JSON(NSNumber(value: 87621.12345678))
  ...
  func testNumberGreaterThan() {
    ...
    let jsonL3 = JSON(NSNumber(value: 87621.12345678))
    let jsonR3 = JSON(NSNumber(value: 87621.1234567))
  ...
  func testDictionary() {
    let jsonL1: JSON = ["2": 2, "name": "Jack", "List": ["a", 1.09, nil]]
    let jsonR1 = JSON(["2": 2, "name": "Jack", "List": ["a", 1.09, NSNull()]])
